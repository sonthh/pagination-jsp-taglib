            ...
            <div class="tab-content">
              <div class="tab-pane tab-chat active" id="tab1" role="tabpanel">
                    ...
                    <div class="be-scroller-chat">
                      <div class="content">
                        ...
                        <div class="contact-list contact-list-recent">
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar1.png" alt="Avatar">
                              <div class="user-data"><span class="status away"></span><span class="name">Claire Sassu</span><span class="message">Can you share the...</span></div></a></div>
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar2.png" alt="Avatar">
                              <div class="user-data"><span class="status"></span><span class="name">Maggie jackson</span><span class="message">I confirmed the info.</span></div></a></div>
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar3.png" alt="Avatar">
                              <div class="user-data"><span class="status offline"></span><span class="name">Joel King		</span><span class="message">Ready for the meeti...</span></div></a></div>
                        </div>
                        <h2>Contacts</h2>
                        <div class="contact-list">
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar4.png" alt="Avatar">
                              <div class="user-data2"><span class="status"></span><span class="name">Mike Bolthort</span></div></a></div>
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar5.png" alt="Avatar">
                              <div class="user-data2"><span class="status"></span><span class="name">Maggie jackson</span></div></a></div>
                          <div class="user"><a href="#"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar6.png" alt="Avatar">
                ...
                <div class="chat-window">
                  <div class="title">
                    <div class="user"><img src="${pageContext.request.contextPath}/adminUrl/assets/img/avatar2.png" alt="Avatar">
