        ...
        <div class="main-content container-fluid">
	          ...
	          <div class="col-sm-8">
		          <form class="row" action="${pageContext.request.contextPath}/admin/user/search" method="get">
		            <div class="col-4">
		              <input class="form-control form-control-sm" style="height: 31px;" required="required" name="q" id="" type="text" placeholder="Search">
		            </div>
		            <div class="col-2">
          ...
          <div class="row">
				    <div class="col-sm-12 d-sm-flex justify-content-sm-center">
				    	<pag:paginate numberOfPagesDisplay="7" currentPage="${page}" uri="${pageContext.request.contextPath}/admin/user" numberOfPages="${numberOfPages}"/>
		        </div>
		      </div>
        </div>
